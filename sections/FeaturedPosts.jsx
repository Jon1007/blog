 ...
 useEffect(() => {
	...
	return(
		<div className="mb-8 container mx-auto">
			<Carousel showDots={true} autoPlay={true} autoPlaySpeed={3000} infinite customRightArrow={customRightArrow}
				customLeftArrow={customLeftArrow} responsive={responsive} itemClass="px-4">
